...
class TvRepositoryImpl implements TvRepository {
  ...
  Future<Either<Failure, String>> saveWatchlist(TvDetail tv) async {
    try {
      final tvTable = TvTable.fromEntity(tv);
      final result = await localDataSource.insertWatchlist(tvTable);
      return Right(result);
    } on ServerException {
      return Left(ServerFailure(''));
    } on SocketException {
  ...
  Future<Either<Failure, String>> removeWatchlist(TvDetail tv) async {
    try {
      final tvTable = TvTable.fromEntity(tv);
      final result = await localDataSource.removeWatchlist(tvTable);
      return Right(result);
    } on ServerException {
      return Left(ServerFailure(''));
    } on SocketException {
